...
excel_path = r"C:\Prabhav\Prabhav HP\Prabhav Projects & Courses\Hardware-Accelerator-for-FFT\Software Benchmarking - Matrix Multiplication\cupy_float_matrix_mult.xlsx"
...
plt.xlabel('Matrix Size (n x n)')
plt.ylabel('Time Taken (seconds)')
plt.title('Floating-Point Matrix Multiplication Performance (NumPy)')
plt.grid(True)
plt.tight_layout()

# Save to same folder as script
script_dir = os.path.dirname(os.path.abspath(__file__))
output_path = os.path.join(script_dir, "numpy_float_matrix_mult_result.png")
